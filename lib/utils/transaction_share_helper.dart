  ...
  static Future<String> buildTransactionMessage(
    ...
    final DateTime transactionDate = rawDate == null
        ...
        : rawDate is String
            ...
            : rawDate as DateTime;
    final date =
        formatLocalizedDateEnglishNumbers(context, transactionDate.toString());
    ...
    buffer.writeln(loc.shareTransactionMessage(
        formattedAmount, currency, transactionType, date));
