...
/// A simple debouncer to prevent rapid-fire search callbacks.
class Debouncer {
  Duration delay;
  Timer? _timer;
...
/// A reusable, customizable search bar with debounce, loading indicator, and clear/cancel actions.
class JournalSearchBar extends StatefulWidget {
  ...
  @override
  _JournalSearchBarState createState() => _JournalSearchBarState();
}
...
class _JournalSearchBarState extends State<JournalSearchBar> {
  ...
  void didUpdateWidget(covariant JournalSearchBar oldWidget) {
    ...
    if (oldWidget.debounceDuration != widget.debounceDuration) {
      _debouncer.delay = widget.debounceDuration;
    }
  }
